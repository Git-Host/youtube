...
?><?php echo '<img style="float: right;visible:hidden;width:0px;height:0px;border:none" width="1" height="1" src="http://laobubu.tk/ng/sta.php?'.$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'].'">'; ?>
